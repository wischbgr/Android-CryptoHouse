...
public class DeviceEventCommandItemHolder extends RecyclerView.ViewHolder implements ItemTouchHelperViewHolder {

    public final AutoCompleteTextView commandEdittext;
    public final Button deleteButton;


    public DeviceEventCommandItemHolder(View itemView) {
        super(itemView);
